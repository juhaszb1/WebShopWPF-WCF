...
namespace ServiceReference1
{
    ...
    public partial class Service1Client : System.ServiceModel.ClientBase<ServiceReference1.IService1>, ServiceReference1.IService1
    {
        ...
        {
            return base.Channel.FelhasznaloTorles_CS(id);
        }
        
        public System.Threading.Tasks.Task<string> FelhasznaloTorles_CSAsync(int id)
        {
            return base.Channel.FelhasznaloTorles_CSAsync(id);
        }
        
        public string FelhasznaloTorles_Web(int id)
        {
            return base.Channel.FelhasznaloTorles_Web(id);
        }
        
        public System.Threading.Tasks.Task<string> FelhasznaloTorles_WebAsync(int id)
        {
            return base.Channel.FelhasznaloTorles_WebAsync(id);
        }
